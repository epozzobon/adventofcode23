...
func main() {
	utils.CheckSolution(Day16, "example1.txt", 1, 46)
	utils.CheckSolution(Day16, "example1.txt", 2, 51)
	utils.CheckSolution(Day16, "input.txt", 1, 7472)
	utils.CheckSolution(Day16, "input.txt", 2, 7716)
}
