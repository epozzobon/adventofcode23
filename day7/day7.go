...
func main() {
	utils.CheckSolution(Day7, "example1.txt", 1, 6440)
	utils.CheckSolution(Day7, "example1.txt", 2, 5905)
	utils.CheckSolution(Day7, "input.txt", 1, 250957639)
	utils.CheckSolution(Day7, "input.txt", 2, 251515496)
}
